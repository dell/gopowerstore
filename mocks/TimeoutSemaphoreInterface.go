...
type mockConstructorTestingTNewTimeoutSemaphoreInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewTimeoutSemaphoreInterface(t mockConstructorTestingTNewTimeoutSemaphoreInterface) *TimeoutSemaphoreInterface {
