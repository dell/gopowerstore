...
// UpdateNASProtectionPolicy provides a mock function with given fields: ctx, id, params
func (_m *Client) UpdateNASProtectionPolicy(ctx context.Context, id string, params *gopowerstore.NASChangePolicy) (gopowerstore.EmptyResponse, error) {
	ret := _m.Called(ctx, id, params)

	var r0 gopowerstore.EmptyResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *gopowerstore.NASChangePolicy) (gopowerstore.EmptyResponse, error)); ok {
		return rf(ctx, id, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *gopowerstore.NASChangePolicy) gopowerstore.EmptyResponse); ok {
		r0 = rf(ctx, id, params)
	} else {
		r0 = ret.Get(0).(gopowerstore.EmptyResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, *gopowerstore.NASChangePolicy) error); ok {
		r1 = rf(ctx, id, params)
	} else {
		r1 = ret.Error(1)
	}
