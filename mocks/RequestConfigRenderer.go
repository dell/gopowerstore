...
type mockConstructorTestingTNewRequestConfigRenderer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewRequestConfigRenderer(t mockConstructorTestingTNewRequestConfigRenderer) *RequestConfigRenderer {
