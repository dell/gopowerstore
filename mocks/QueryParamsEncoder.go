...
type mockConstructorTestingTNewQueryParamsEncoder interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewQueryParamsEncoder(t mockConstructorTestingTNewQueryParamsEncoder) *QueryParamsEncoder {
