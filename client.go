...
type Client interface {
	...
	GetRemoteSnapshotSessionByID(ctx context.Context, sessionId string, remoteSnapResp []RemoteSnapshotSession) ([]RemoteSnapshotSession, error)
	CreateRemoteSnapshotSession(ctx context.Context, createParams *RemoteSnapshotSessionCreate) (resp CreateResponse, err error)
	CreateRemoteSystem(ctx context.Context, createParams CreateRemoteSystem) (resp RemoteSystem, err error)
